...
exports.mergeResolveTheirs = exports.equivalent = exports.loadJSON = exports.createGraph = exports.Graph = void 0;
//     FBP Graph
    ...
    save(file, callback) {
        ...
        if ((0, Platform_1.isBrowser)()) {
            ...
            promise = new Promise((resolve, reject) => {
                ...
                (0, fs_1.writeFile)(filename, json, 'utf-8', (err) => {
                    if (err) {
                        reject(err);
                        return;
                    }
